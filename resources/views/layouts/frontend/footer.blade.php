...
<footer class="text-center mt-5" style="background-color: #ffffff">
    ...
    <div class="container pt-3 pb-3">
        ...
        <section class="mb-2">
            <a class="btn btnoutlinelight  m-1" href="javascript:void(0)" role="button">
    ...
    <div class="text-center p-3" style="background-color: #f4f7fa;">
        © 2025 Copyright:
        <a class="text-muted text-decoration-none" href="https://ddtsoftwareandecommerce.com/">DDT Software & E Comm Pvt Ltd</a>
    </div>
