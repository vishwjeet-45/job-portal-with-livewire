...
@section('page_heading', 'Languages List')
...
<x-livewire-modal id="createModal" title="Create Languag" modal_size="md">
    <livewire:languag.create />
</x-livewire-modal>
<x-livewire-modal id="editModal" title="Edit Languag" modal_size="md">
    <livewire:languag.edit />
</x-livewire-modal>
@endsection
