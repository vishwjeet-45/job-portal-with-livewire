...
<x-livewire-modal id="createModal" title="Create Industry" modal_size="md">
    <livewire:industry.create />
</x-livewire-modal>
<x-livewire-modal id="editModal" title="Edit Industry" modal_size="md">
    <livewire:industry.edit />
</x-livewire-modal>
@endsection
...
<script type="text/javascript">
    $(document).ready(function() {
        let url = "/admin/industries";
        initializeDataTable('#dataTable', url, ['id','name','industryType.name','action'], [[1, 'desc']], true);
    });
</script>
@endpush
