...
<x-livewire-modal id="createModal" title="Create Functional Area" modal_size="md">
    <livewire:functional-area.create />
</x-livewire-modal>
<x-livewire-modal id="editModal" title="Edit Industry" modal_size="md">
    <livewire:functional-area.edit />
</x-livewire-modal>
@endsection
...
<script type="text/javascript">
    $(document).ready(function() {
        let url = "/admin/functional-areas";
        initializeDataTable('#dataTable', url, ['id','name','industry.name','action'], [[1, 'desc']], true);
    });
</script>
@endpush
