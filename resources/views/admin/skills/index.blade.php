...
@section('page_heading', 'Skill List')
@can('skills.create')
@section('top_buttion')
...
<x-livewire-modal id="createModal" title="Create Skill" modal_size="md">
    <livewire:skill.create />
</x-livewire-modal>
<x-livewire-modal id="editModal" title="Edit Skill" modal_size="md">
    <livewire:skill.edit />
</x-livewire-modal>
@endsection
